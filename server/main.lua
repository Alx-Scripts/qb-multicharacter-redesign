...
RegisterNetEvent('qb-multicharacter:server:hideLoadingScreen')
AddEventHandler('qb-multicharacter:server:hideLoadingScreen', function()
    local src = source
    Wait(2000)
    TriggerClientEvent('qb-multicharacter:client:hideLoadingScreen', src)
end)
...
RegisterNetEvent("qb-multicharacter:server:exit")
AddEventHandler("qb-multicharacter:server:exit", function()
    DropPlayer(source, "Has salido!")
end)
